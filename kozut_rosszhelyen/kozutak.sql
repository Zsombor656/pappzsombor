...
--
-- Gép: 127.0.0.1:3307
-- Létrehozás ideje: 2025. Sze 16. 19:47
...
--
-- Tábla szerkezet ehhez a táblához `kozutak_hossza`
--
...
--
-- A tábla adatainak kiíratása `kozutak_hossza`
--
...
CREATE TABLE `megyek` (
  `Mid` int(11) NOT NULL,
  `megyenev` varchar(100) DEFAULT NULL,
  `Rid` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
--
-- A tábla indexei `kozutak_hossza`
--
...
--
-- Megkötések a táblához `kozutak_hossza`
--
ALTER TABLE `kozutak_hossza`
